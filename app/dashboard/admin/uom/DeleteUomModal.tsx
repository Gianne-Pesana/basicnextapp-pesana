...
export default function DeleteUomModal({ isOpen, onClose, onDelete, uom }: DeleteUomModalProps) {
      ...
      <div className="w-full max-w-sm bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="p-6 text-center">
          <p className="text-gray-700 mb-6">
            Are you sure you want to delete the UOM <span className="font-bold text-red-600">"{uom.name}"</span>?
            <br />
